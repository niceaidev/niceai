...
import { serialize, unserialize } from './utils/json';
import { REDIS_SUCCESS } from './consts';
...
export function cache(redis: Redis, opts: { prefix?: string } = {}) {
  return new Cache(redis, opts);
}
